...
import com.sura.policycenter.selenium.steps.ExpedirCambioDePolizaUWPEPSSteps;
...
public class ExpedirCambioDePolizaUWPEPSDefinitions {

    @Steps
    CotizacionMRCSteps cotizacionMRCSteps;

    @Steps
    ExpedirCambioDePolizaUWPEPSSteps expedirCambioDePolizaUWPEPSSteps;
