package com.sura.guidewire.policycenter.pages;
 ...
 import com.sura.guidewire.policycenter.util.menu.Navegacion;
import com.sura.guidewire.policycenter.util.menu.acciones.administracion.AdminCodAgenteNuevoPage;
import com.sura.guidewire.policycenter.util.menu.acciones.administracion.AdminGrupoNuevoPage;
import com.sura.guidewire.policycenter.util.menu.acciones.administracion.AdminNuevoGrupoAfinidadPage;
import com.sura.guidewire.policycenter.util.menu.acciones.administracion.AdminOrganizacionNuevaPage;
import com.sura.guidewire.policycenter.util.menu.acciones.administracion.AdminUsuarioNuevoPage;
import com.sura.guidewire.policycenter.util.menu.acciones.administracion.AdminVerificarErrorPatronPage;
import com.sura.guidewire.policycenter.util.menu.acciones.contacto.ContactoNuevaCuentaPage;
 import com.sura.guidewire.policycenter.util.menu.acciones.escritorio.EscritorioNuevaCuentaPage;
import com.sura.guidewire.policycenter.util.menu.acciones.escritorio.EscritorioNuevoEnvioPage;
...
import com.sura.guidewire.policycenter.util.menu.opciones.cuenta.OpcionesResumenCuentaPage;
 import com.sura.guidewire.policycenter.util.menu.superior.contacto.BuscarContactoPage;
import com.sura.guidewire.policycenter.util.menu.superior.contacto.NuevaCompaniaPage;
import com.sura.guidewire.policycenter.util.menu.superior.contacto.NuevaPersonaPage;
import com.sura.guidewire.policycenter.util.menu.superior.cuenta.CuentaBuscarPage;
import com.sura.guidewire.policycenter.util.menu.superior.cuenta.NuevaCuentaPage;
import com.sura.guidewire.policycenter.util.menu.superior.equipo.EquipoPage;
 import com.sura.guidewire.policycenter.util.menu.superior.poliza.NuevoEnvioPage;
import com.sura.guidewire.policycenter.util.menu.superior.poliza.PolizaBuscarPage;
 import com.sura.guidewire.policycenter.util.menu.acciones.cuenta.*;
 import com.sura.guidewire.policycenter.util.menu.superior.administracion.*;
 import com.sura.guidewire.policycenter.util.menu.superior.buscar.*;
 import com.sura.guidewire.policycenter.util.menu.superior.escritorio.*;
