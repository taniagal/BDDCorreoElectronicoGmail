...
public class DireccionesDeContactoVinculadasPage extends PageObject {
    ...
    public void irALosContactosDeLaCuenta() {
        WebElementFacade mnuContactos = pageUtil.esperarElemento(".//*[@id='AccountFile:MenuLinks:AccountFile_AccountFile_Contacts']/div");
        mnuContactos.click();
    }
    ...
    private void irAEditarDireccion(String nombreContactoDos) {
        ...
        WebElementFacade btnAsociarDireccion = pageUtil.esperarElemento(XPATH_BOTON_ASOCIAR_DIRECCION);
    ...
    public void vincularDireccionAContacto(String nombreContacto) {
        ...
        WebElementFacade botonLaMismaDireccionQue = pageUtil.esperarElemento(".//img[@src='images/app/drop_button.png']");
        botonLaMismaDireccionQue.click();
        WebElementFacade menuContactoTitular = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:LinkedAddressInputSet:LinkAddressMenu:0:contactDetail']");
        accion.moveToElement(menuContactoTitular).release(menuContactoTitular).build().perform();
        WebElementFacade menuContactoDireccionPrincipal = pageUtil.esperarElemento(".//*[@id='EditAccountPopup:EditAccountScreen:LinkedAddressInputSet:LinkAddressMenu:0:contactDetail']");
        ...
        WebElementFacade botonActualizar = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:Update-btnInnerEl']");
    ...
    public void seleccionarContacto() {
        ...
        WebElementFacade btnAsociarDireccion = pageUtil.esperarElemento(XPATH_BOTON_ASOCIAR_DIRECCION);
        btnAsociarDireccion.click();
        btnEditarDireccion = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:LinkedAddressInputSet:LinkAddressMenu:EditAddress']");
        btnEditarDireccion.click();
    }

    public void validarInformacionContacto(ExamplesTable resultadoModificacionDireccion) {
        WebElementFacade txtPaisContacto = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:AddressInputSet:globalAddressContainer:GlobalAddressInputSet:Country-inputEl']");
    ...
    public void validarInfoContactosAsociadosADireccion(ExamplesTable contactosDireccionVinculada) {
        ...
        WebElementFacade botonCancelarDetalles = pageUtil.esperarElemento(".//*[@id='LinkedAddressEditPopup:Cancel-btnInnerEl']");
    ...
    public void editarDireccion(String direccion) {
        WebElementFacade campoDireccionDetalle = pageUtil.esperarElemento(XPATH_DIRECCION_DETALLE);
    ...
    public void editarDireccionEnPestaniaDirecciones(String direccion) {
        WebElementFacade pestanaDirecciones = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:AccountContactCV:AddressesCardTab-btnInnerEl']");
    ...
    public void seleccionarUnContacto(String nombreContacto) {
        WebElementFacade contactoAEditar = pageUtil.esperarElemento(".//*[@id='AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactsLV:" + encontrarContacto(nombreContacto).toString() + ":Name']");
    ...
    public void editarDireccionCampoPais(String pais) {
        WebElementFacade campoPais = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:AddressInputSet:globalAddressContainer:GlobalAddressInputSet:Country-inputEl']");
        campoPais.clear();
    ...
    public void clicEnBotonCancelar(){
        WebElementFacade btnCancelar = pageUtil.esperarElemento(XPATH_BOTON_CANCELAR);
    ...
    public void validarDireccionEstandarizada(String direccionEstandarizada, String nombreContacto) {
        ...
        WebElementFacade campoDireccionContacto = pageUtil.esperarElemento(XPATH_DIRECCION_DETALLE);
    ...
    public void validarDireccionVinculada(String direccionVinculada, String nombreContacto) {
        ...
        WebElementFacade botonCancelar = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:Cancel']");
        botonCancelar.click();
    ...
    public void seleccionarEditarDireccionVinculada() {
        WebElementFacade botonCambiarA = pageUtil.esperarElemento(XPATH_BOTON_ASOCIAR_DIRECCION);
        botonCambiarA.click();
        WebElementFacade botonEditarDireccionVinculada = pageUtil.esperarElemento(".//*[@id='EditAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:LinkedAddressInputSet:LinkAddressMenu:EditAddress']");
    ...
    public void editarDireccionYDesligar(String direccion) {
        this.escribirEnElCampo(direccion, txtDireccion);
        WebElementFacade botonActualizarDesligar = pageUtil.esperarElemento(".//*[@id='LinkedAddressEditPopup:UpdateAndUnlinkButton']");
    ...
    public Integer encontrarContacto(String nombreContacto) {
        WebElementFacade tablaContactos = pageUtil.esperarElemento(".//*[@id='AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactsLV-body']");
        Integer filaBoton = 0;
    ...
    public void seleccionarCrearContactoSecundarioPersonaNatural() {
        Actions accion = new Actions(getDriver());
        WebElementFacade botonCrearNuevoContacto = pageUtil.esperarElemento(".//*[@id='AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactsLV_tb:addContactButton-btnInnerEl']");
        botonCrearNuevoContacto.click();
        WebElementFacade opcionContactoSecundario = pageUtil.esperarElemento(".//*[@id='AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactsLV_tb:addContactButton:3:roleType']");
        accion.moveToElement(opcionContactoSecundario).release(opcionContactoSecundario).build().perform();
        WebElementFacade opcionNuevoContactoPersonaNatural = pageUtil.esperarElemento(".//span[contains(@id,'AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactsLV_tb:addContactButton:3:roleType:0:contactType-textEl')]");
    ...
    public void desplegarListaDeContactosParaAsignarLaDireccion() {
        WebElementFacade botonLaMismaDireccionQue = pageUtil.esperarElemento(".//*[@id='NewAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:LinkedAddressInputSet:LinkAddressMenu:LinkAddressMenuMenuIcon']/img");
        botonLaMismaDireccionQue.click();
    }
    ...
    public void validarContactosAsociados(ExamplesTable contactosAsociados) {
        ...
        WebElementFacade menuContactoTitular = pageUtil.esperarElemento(".//*[@id='NewAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:LinkedAddressInputSet:LinkAddressMenu:0:contactDetail']");
        menuContactoTitular.click();
        WebElementFacade menuContactoDireccionPrincipal = pageUtil.esperarElemento(".//*[@id='NewAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:LinkedAddressInputSet:LinkAddressMenu:0:contactDetail:PrimaryAddress']");
    ...
    public void validarAsociacionDeDireccionAContactoSecundario(ExamplesTable direccionAsociada) {
        ...
        WebElementFacade campoPais = pageUtil.esperarElemento(".//*[@id='NewAccountContactPopup:ContactDetailScreen:AccountContactCV:AccountContactDV:AddressInputSet:globalAddressContainer:GlobalAddressInputSet:Country-inputEl']");
    ...
    public void validarEtiquetasDeLaVentana(String titulo, String botonLigagas, String botonDesligar) {
        WebElementFacade tituloDeVentana = pageUtil.esperarElemento(".//*[@id='LinkedAddressEditPopup:ttlBar']");
        WebElementFacade botonActualizarLigadas = pageUtil.esperarElemento(".//*[@id='LinkedAddressEditPopup:UpdateAllButton-btnInnerEl']");
        ...
        WebElementFacade pestaniaDirecciones = pageUtil.esperarElemento(".//*[@id='AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactCV:AddressesCardTab-btnInnerEl']");
        pestaniaDirecciones.click();

        WebElementFacade tituloPanelPestaniaDirecciones = pageUtil.esperarElemento(".//*[@id='AccountFile_Contacts:AccountFile_ContactsScreen:AccountContactCV:AddressesPanelSet:0']");
