...
public class TarifaTasaUnicaPage extends PageUtil {
    ...
    public void verificarTarifacionSinCambio() {
        MatcherAssert.assertThat("Error, hubo un cambio en el valor de la tarifacion durante el policy change, Expected: " +
    ...
    public void verificarTarifaRenovacionSinCambio() {
        ...
        MatcherAssert.assertThat("No hay tarifacion en la renovacion", labelPrimaTotalRenovacion.containsText("00 (COP)"));
    }

    public void verificarCambioDeTarifa() {
        MatcherAssert.assertThat("Error, no hubo cambio en el valor de la tarifacion durante el policy change", !primaTotal.equals(labelPrimaTotalCambio.getText()));
    }
