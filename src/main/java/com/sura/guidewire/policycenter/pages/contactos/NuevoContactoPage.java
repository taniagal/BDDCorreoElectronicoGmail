...
public class NuevoContactoPage extends PageUtil {
    ...
    /**
     * Escenario nuevo contactos persona juridica
     * @param razonSocial
     */
    ...
    public void verificarContactoExistente() {
        ...
        waitUntil(1000);
        MatcherAssert.assertThat(this.contactoExistente.getText().toString(), Matchers.containsString("Ya existe un contactos con el mismo número de identificación"));
    }
