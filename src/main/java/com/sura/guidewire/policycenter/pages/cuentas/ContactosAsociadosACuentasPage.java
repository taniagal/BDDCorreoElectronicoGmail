package com.sura.guidewire.policycenter.pages.cuentas;
...
public class ContactosAsociadosACuentasPage extends PageUtil {
    ...
    /*
    * Informacion tab detalle de contactos
    * */
    ...
    @FindBy(xpath = ".//a[contains(.,'Crear nuevo contactos')]")
    ...
    public void verificarListaContactoNoEsNulo() {
        List<WebElementFacade> contactos = getListaContactos();
        MatcherAssert.assertThat("La cuentas debe tener contactos de tipo persona juridica o natural", !contactos.isEmpty());
    }
    ...
    public void verificarRolesFuncionesNoEsNulo() {
        ...
        MatcherAssert.assertThat("El contactos debe tener roles o funciones asignados", !rolesFunciones.isEmpty());
        waitABit(1000);
    }

    public void verificarDireccioneNoEsNulo() {
        List<WebElementFacade> direcciones = getListaDirecciones();
        MatcherAssert.assertThat("El contactos debe tener direcciones asignados", !direcciones.isEmpty());
        waitABit(1000);
    }
    ...
    public Boolean esContactoAsociado(String nombreContacto) throws Exception {
        ...
        MatcherAssert.assertThat("El contactos se asocio a la cuentas exitosamente", esAsociado);
        return esAsociado;
    }
    ...
    public void contactoEliminado(String contactoEliminado) {
        ...
        for (WebElementFacade contacto : getListaContactos()) {
            if (((WebElementFacade) contacto).getText().split("\n")[1].toString().equals(contactoEliminado)) {
                ...
                MatcherAssert.assertThat("No existe el contactos",noExiste);
                break;
            }
        }
    }
