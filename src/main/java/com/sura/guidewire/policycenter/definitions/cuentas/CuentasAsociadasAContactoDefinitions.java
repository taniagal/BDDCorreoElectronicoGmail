...
public class CuentasAsociadasAContactoDefinitions {
    ...
    @Given("que voy a consultar un contactos")
    public void seleccionarOpcionBuscarContacto() {
        contactoSteps.navegarBarraSuperior();
    }

    @When("consulte  un contactos con cuentas asociadas como: <nombre> <apellido>")
    ...
    @When("consulte  un contactos sin cuentas asociadas como: <nombre> <apellido>")
