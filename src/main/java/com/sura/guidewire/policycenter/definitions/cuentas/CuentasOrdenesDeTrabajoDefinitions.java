...
import com.sura.guidewire.policycenter.steps.cuentas.CuentasOrdenesDeTrabajoSteps;
...
public class CuentasOrdenesDeTrabajoDefinitions {
    ...
    @Given("Estoy buscando una cuentas <numCuenta>")
    ...
    @When("consulte todas las transacciones de la cuentas")
