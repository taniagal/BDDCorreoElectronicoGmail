...
import com.sura.guidewire.policycenter.steps.contactos.ContactoOrdenesDeTrabajoSteps;
import com.sura.guidewire.policycenter.steps.cuentas.CuentasAsociadasAContactoSteps;
...
public class ContactoOrdenesDeTrabajoDefinitions {
    ...
    @Given("consulte  un contactos del tipo <tipoContacto> con transacciones como: <nombre> <apellido>")
    ...
    @Given("consulte  un contactos del tipo <tipoContacto> con transacciones como: <razonSocial>")
    ...
    @Given("consulte  un contactos del tipo <tipoContacto> con transacciones como: <nombre> <apellido> y seleccione el registro <numero>")
    ...
    @When("consulte las transacciones del contactos")
    ...
    @Then("no debo ver la poliza <transaccion> asociada a una colectiva en las transacciones del contactos")
