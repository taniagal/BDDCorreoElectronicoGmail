...
import com.sura.guidewire.policycenter.steps.cuentas.CuentaNuevaSteps;
...
public class CuentaNuevaDefinitions {
    ...
    @When("quiera crear una cuentas para un contactos persona natural e ingrese documento, tipo de documento <tipo_documento>")
    ...
    @Then("se debe crear la cuentas con el cliente <primer_nombre> <primer_apellido> persona natural")
     ...
     * ESCENARIO 2
     */
    @When("quiera crear una cuentas para un contactos persona juridica e ingrese nit, tipo de documento <tipo_documento>")
    ...
    @Then("se debe crear la cuentas con el cliente <razon_social> persona juridica")
     ...
     * ESCENARIO 3
     */
    @Then("No debe permitir crear una nueva cuentas y debe mostrar el mensaje <mensaje> y <mensaje2>")
