...
import com.sura.guidewire.policycenter.steps.cuentas.BusquedaDeCuentasSteps;
...
public class BusquedaDeCuentasDefinitions {
    ...
    @When("ingrese la informacion de tipo de documento <tipoDocumento> y numero de documento <numeroDocumento> del titular de la cuentas")
    ...
    @When("ingrese la informacion de tipo de razon social <razonSocial> del titular de la cuentas")
    ...
    @When("ingrese la informacion de nombre comercial <nombreComercial> del titular de la cuentas")
    ...
    @When("ingrese la informacion de tipo de razon social <razonSocial> del titular de la cuentas e ingrese informacion de tipo persona natural <primerNombre>")
    ...
    @When("ingrese la informacion de nombre comercial <nombreComercial> del titular de la cuentas e ingrese informacion de tipo persona natural <primerNombre>")
    ...
    @When("ingrese la informacion de nombre comercial <nombreComercial> del titular de la cuentas e ingrese razon social <razonSocial>")
    ...
    @Then("me debe mostrar numero de cuentas <numeroCuenta>, nombre <nombre> y direccion <direccion>")
