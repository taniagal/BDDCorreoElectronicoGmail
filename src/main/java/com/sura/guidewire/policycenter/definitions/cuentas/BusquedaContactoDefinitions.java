...
public class BusquedaContactoDefinitions {
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por nombre <nombre> y apellido <apellido>")
    ...
    @When("quiera consultar contactos de tipo persona juridica <tipoDoc> por razon social <razonSocial>")
    ...
    @When("quiera consultar contactos de tipo persona juridica <tipoDoc> sin ingresar ningun filtro")
    ...
    @When("quiera consultar contactos de tipo persona juridica <tipoDoc> por numero de documento <numDoc>")
    ...
    @When("quiera consultar contactos de tipo persona juridica por tipo de documento <tipoDoc>")
    ...
    @When("quiera consultar contactos de tipo persona juridica por tipo <tipoDoc> y numero de identificacion <numDoc>")
    public void whenConsultarPersonaJuridicaTipoNumDoc(@Named("tipoDoc") String tipoDoc, @Named("numDoc") String numDoc) {
        buscarContactoSteps.consultarContactoTipoNumDoc(tipoDoc, numDoc);
    }

    @When("quiera consultar contactos de tipo persona natural por tipo <tipoDoc> y numero de identificacion <numDoc>")
    public void whenConsultarPersNatTipoNumId(@Named("tipoDoc") String tipoDoc, @Named("numDoc") String numDoc) {
        buscarContactoSteps.consultarContactoTipoNumDoc(tipoDoc, numDoc);
    }

    @When("quiera consultar contactos de tipo persona natural por tipo de documento <tipoDoc>")
    public void whenConsultarPersNatTipoDoc(@Named("tipoDoc") String tipoDoc){
        buscarContactoSteps.consultarContactoTipoNumDoc(tipoDoc, "");
    }

    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por numero de documento <numDoc>")
    public void whenConsultarPersNatNumDoc(@Named("tipoDoc") String tipoDoc, @Named("numDoc") String numDoc) {
        buscarContactoSteps.consultarContactoTipoNumDoc(tipoDoc, numDoc);
    }

    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por apellido <apellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por primer nombre <primerNombre>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por segundo nombre <segundoNombre>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por primer apellido <primerApellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por segundo apellido <segundoApellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por primer nombre <primerNombre> y primer apellido <primerApellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por segundo nombre <segundoNombre> y segundo apellido <segundoApellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por primer nombre <primerNombre> y segundo apellido <segundoApellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por segundo nombre <segundoNombre> y primer apellido <primerApellido>")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDo> sin ingresar ningun filtro")
    ...
    @When("quiera consultar contactos de tipo persona natural <tipoDoc> por primer apellido <primerApellido> y segundo apellido <segundoApellido>")
    ...
    @Then("no debo ver la informacion del contactos de tipo persona juridica")
    ...
    @Then("no debo ver la informacion del contactos de tipo persona natural")
    ...
    @When("quiera consultar contactos de tipo persona juridica <tipoDoc> por nombre comercial <nombreComercial>")
    ...
    @Then("debo ver la informacion del contactos de tipo persona natural <filtro1> <filtro2>")
