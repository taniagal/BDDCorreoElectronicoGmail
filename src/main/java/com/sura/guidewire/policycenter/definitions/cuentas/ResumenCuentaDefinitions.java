...
import com.sura.guidewire.policycenter.steps.cuentas.ResumenCuentaSteps;
...
public class ResumenCuentaDefinitions {
    ...
    public ResumenCuentaDefinitions(){
        infoResumenCuenta.put("lblResumenCuenta", "Resumen de la cuentas");
        ...
        infoResumenCuenta.put("estadoCuenta", "Estado de la cuentas");
    ...
    @Given("estoy en el resumen de una cuentas <numCuenta> de tipo persona natural <tipoCuenta>")
    ...
    @Given("estoy en el resumen de una cuentas <numCuenta> de tipo persona juridica <tipoCuenta>")
    public void consultarResumenCtaPersonaJuridica(@Named("numCuenta") String numCuenta){
        historialCuentaSteps.seleccionarCuenta(numCuenta);
        resumenCuentaSteps.consultarResumenCuenta();
    }

    @When("ingrese al resumen de la cuentas")
    public void consultarResumenCuenta(){
        resumenCuentaSteps.consultarResumenCuenta();
    }

    @When("ingrese a editar dicha cuentas")
    ...
    @When("ingrese a editar la direccion de la cuentas e indique una direccion <direccion> que se pueda estandarizar")
    @Manual
    public void whenValidarDireccionEstandarizada() {
        // Se realiza manualmente.
    }

    @When("ingrese a editar la direccion de la cuentas e indique una direccion <direccion> que no se pueda estandarizar")
    @Manual
    public void whenValidarDireccionNoEstandarizada() {
        // Se realiza manualmente.
    }

    @Then("puedo visualizar el resumen de la cuentas seleccionada de tipo persona juridica, el listado de actividades, vigencias\n" +
            "de las polizas asociadas a la cuentas y transacciones pendientes de las polizas asociadas a la cuentas")
    public void verInfoResumenCuentaPersonaJuridica(){
        resumenCuentaSteps.verInfoResumenCuenta(infoResumenCuenta);
    }

    @Then("puedo visualizar el resumen de la cuentas seleccionada de tipo persona natural, el listado de actividades, vigencias \n" +
            "de las polizas asociadas a la cuentas y transacciones pendientes de las polizas asociadas a la cuentas")
