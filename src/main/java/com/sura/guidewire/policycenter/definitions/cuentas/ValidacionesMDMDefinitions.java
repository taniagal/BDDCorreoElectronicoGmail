...
public class ValidacionesMDMDefinitions {
    ...
    @When("quiera crear una cuentas para un contactos e ingrese documento, tipo de documento <tipo_documento>")
    ...
    @When("quiera crear una cuentas para un contactos e ingrese documento <documento>, tipo de documento <tipo_documento>")
    ...
    @When("quiera crear una cuentas para un contactos persona juridica e tipo de documento <tipo_documento>")
    ...
    @Then("no debe permitir crear una nueva cuentas y debe mostrar el mensaje <mensaje>")
    public void verificarMensaje(@Named("mensaje") String mensaje){
        cuentaNuevaSteps.verificar_mensaje(mensaje);
    }

    @Then("no debe permitir crear una nueva cuentas y no debe mostrar el mensaje <mensaje>")
