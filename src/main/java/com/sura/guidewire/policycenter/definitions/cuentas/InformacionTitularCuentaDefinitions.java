...
import com.sura.guidewire.policycenter.steps.cuentas.InformacionTitularCuentaSteps;
...
public class InformacionTitularCuentaDefinitions {
    ...
    @Given("que existe titular de la cuentas con <tipoDoc>, <nombre> y <apellido>")
    ...
    @When("ingrese a informacion del titular de la cuentas")
    ...
    @Then("el nombre del titular de la cuentas debe aparecer con el nombre completo <nombreCompleto>, es decir, nombre 1 seguido de nombre 2 seguido de apellido 1 seguido de apellido 2.")
