...
import com.sura.guidewire.policycenter.steps.contactos.DetallesContactoSteps;
...
public class DetallesContactoEdicionDefinitions {
     ...
     * ESCENARIO 1
     */
    @When("quiera editar la informacion del contactos con <tipo_documento> c. <documento>")
    ...
    @Then("se deben habilitar la edicion de cierta informacion del contactos, actualizar y visualizar los cambios")
    ...
    @Then("se deben habilitar la edicion de cierta informacion del contactos, actualizar y visualizar los cambios de persona juridica")
