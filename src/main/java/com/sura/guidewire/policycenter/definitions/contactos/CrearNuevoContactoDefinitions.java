...
import com.sura.guidewire.policycenter.steps.contactos.CrearNuevoContactoSteps;
...
public class CrearNuevoContactoDefinitions {
    ...
    @Given("estoy en la pantalla de crear contactos persona natural")
     ...
     */
    @Given("estoy en la pantalla de crear contactos persona juridica")
    ...
    @Then("debe validar que el contactos ya existe")
