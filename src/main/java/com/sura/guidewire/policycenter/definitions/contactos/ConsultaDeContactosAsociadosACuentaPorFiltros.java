...
/**
 * @escenario: Consultar contactos asociados a una cuentas haciendo uso de los filtros rol y tipo persona
 */
public class ConsultaDeContactosAsociadosACuentaPorFiltros {
    ...
    @When("filtre los contactos asociados a una cuentas por el rol $filtro en el combo con valor $combo")
    @Alias("filtre los contactos asociados a una cuentas por el tipo de persona $filtro en el combo con valor $combo")
    ...
    @Then("debo ver contactos asociados a esta cuentas que cumplan con el filtro $filtro en la columna $columna")
