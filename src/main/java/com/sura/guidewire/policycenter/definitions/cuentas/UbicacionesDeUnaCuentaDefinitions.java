...
import com.sura.guidewire.policycenter.steps.cuentas.UbicacionesDeUnaCuentaSteps;
...
public class UbicacionesDeUnaCuentaDefinitions {
    ...
    @Given("que tengo una cuentas <cuentas>")
    public void givenQueTengoUnaCuenta(@Named("cuentas") String cuenta) {
