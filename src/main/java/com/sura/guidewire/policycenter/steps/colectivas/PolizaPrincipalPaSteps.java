...
public class PolizaPrincipalPaSteps extends ScenarioSteps {
    ...
    public void validarQueElDetalleDeVehiculosNoEsVisibleEnLaCotizacion() {
        ...
        MatcherAssert.assertThat(polizaPrincipalPaPages.validarTablaTituloVehiculosEnCotizacion(), Is.is(Matchers.equalTo(false)));
    }
    ...
    public void clicMenuVehiculo() {
        polizaPrincipalPaPages.clicMenuVehiculo();
    }
}
