...
public class PlanDeTrabajoSteps extends ScenarioSteps {
    ...
    @Step
    public void ingresarAlPlanDeTrabajoSoloCancelacion(){
        planDeTrabajo.ingresarALaOpcionPlanDeTrabajoSoloCancelacion();
    }
    @Step
    ...
    @Step
    public void ingresarAlPlanDeTrabajoPolizaNueva() {
        planDeTrabajo.ingresarALaOpcionPlanDeTrabajo();
    }
}
