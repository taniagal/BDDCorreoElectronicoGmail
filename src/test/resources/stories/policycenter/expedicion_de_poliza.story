...
| 22222228   | CAROLINA OCHOA con CEDULA DE CIUDADANIA - 71318883 es un riesgo no estándar y debe ser autorizado.^ANTONIO RESTREPO con CEDULA DE CIUDADANIA - 71123456 es un riesgo no estándar y debe ser autorizado.^GLADYS OCHOA con CEDULA DE CIUDADANIA - 94372371 es un riesgo no estándar y debe ser autorizado. | Ver cotización (N.° 22222228) | Ver póliza (N.° | Ir al administrador de cotizaciones para esta cuenta | Hacer una cotización para una cuenta diferente | Ir al escritorio |
!-- Riesgos Consultables: Tomador - Asegurado - Placa, motor, chasis
| 22222210   | JOSE PAEZ ALZATE, El tomador es un riesgo no estándar y no es posible gestionar la solicitud por este canal.                                                                                                                                                                                             | Ver cotización (N.° 22222210) | Ver póliza (N.° | Ir al administrador de cotizaciones para esta cuenta | Hacer una cotización para una cuenta diferente | Ir al escritorio |
| 22222227   | DIEGO VELEZ, El asegurado es un riesgo no estándar y no es posible gestionar la solicitud por este canal.                                                                                                                                                                                                | Ver cotización (N.° 22222227) | Ver póliza (N.° | Ir al administrador de cotizaciones para esta cuenta | Hacer una cotización para una cuenta diferente | Ir al escritorio |
| 22222226   | T64497, La placa es un riesgo no estándar y no es posible gestionar la solicitud por este canal.^AB3C2, El motor es un riesgo no estándar y no es posible gestionar la solicitud por este canal.^CH212121, El chasis es un riesgo no estándar y no es posible gestionar la solicitud por este canal.     | Ver cotización (N.° 22222226) | Ver póliza (N.° | Ir al administrador de cotizaciones para esta cuenta | Hacer una cotización para una cuenta diferente | Ir al escritorio |
