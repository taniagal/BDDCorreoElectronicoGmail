...
Scenario: Validar longitud de nombres y apellidos
Given estoy en busqueda de contactos
When quiera consultar contacto de tipo persona natural <tipoDoc> por primer nombre <primerNombre> y primer apellido <primerApellido>
And la longitud de alguno de ellos <primerNombre> <primerApellido> sea inferior a dos caracteres
Then no debo ver la informacion del contacto de tipo persona natural
And debo ver un <mensaje> de alerta indicando que la longitud debe ser mayor o igual a dos caracteres

Examples:
|tipoDoc             |primerNombre|primerApellido|mensaje|
|CEDULA DE CIUDADANIA|Y           |GALLEGO       |No hay suficiente información para la búsqueda. Si desea buscar por tipo y número de documento ambos deben ser obligatorios. Si desea buscar por nombre debe ingresar al menos dos campos, incluido un nombre y al menos 2 caracteres por cada campo (4 en el caso de empresas).|

Scenario: Validar longitud de razon social
Given estoy en busqueda de contactos
When quiera consultar contacto de tipo persona juridica <tipoDoc> por razon social <razonSocial>
...
|NIT     |VAR        |No hay suficiente información para la búsqueda. Si desea buscar por tipo y número de documento ambos deben ser obligatorios. Si desea buscar por nombre debe ingresar al menos dos campos, incluido un nombre y al menos 2 caracteres por cada campo (4 en el caso de empresas).|

Scenario: Validar longitud de nombre comercial
Given estoy en busqueda de contactos
When quiera consultar contacto de tipo persona juridica <tipoDoc> por nombre comercial <nombreComercial>
