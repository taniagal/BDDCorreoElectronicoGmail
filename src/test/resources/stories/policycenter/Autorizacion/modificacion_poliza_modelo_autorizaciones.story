...
Narrative:
Al hacer una modificacion de póliza con fecha retroactiva de 30 días hacia atrás. El sistema debe generar automáticamente un mensaje indicando que se requiere una autorización.
...
Scenario: Reglas que requieren autorizacion:uso vehiculo,modelo vehiculo, valor minimo no tiene
Given se tienen los siguientes parametros para la busqueda
|oficina|asesor     |regla                                                                              | canal     |                                                                                                                                                                                                                                                                                                                                                                     |canal |
