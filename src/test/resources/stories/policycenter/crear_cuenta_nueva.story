...
Examples:
|tipo_documento      |fecha_nacimiento|primer_nombre|primer_apellido|nombre_organizacion|agente|
|CEDULA DE CIUDADANIA|02/12/1990      |SASHA        |AKERMAN        |Sura               |INT-3 |
...
Examples:
|tipo_documento       |documento |fecha_nacimiento |primer_nombre |primer_apellido |nombre_organizacion|agente|mensaje                                                    |mensaje2|
|CEDULA DE CIUDADANIA |1234567891|02/15/2012       |SASHA         |AKERMAN         |Sura               |INT-3 |Ya existe un contacto con el mismo número de identificación|Por políticas de la compañia no es posible crear una cuenta a una persona menor de 16 años|
