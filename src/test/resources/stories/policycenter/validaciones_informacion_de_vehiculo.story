...
And agrege un vehiculo con codigo fasecolda <codigo> que no existe
Then debo ingresar un nuevo codigo

Examples:
|cuenta     |organizacion|canal            |producto|codigo|
|C000888888 |Sura        |Canal Tradicional|Autos   |acb123|
